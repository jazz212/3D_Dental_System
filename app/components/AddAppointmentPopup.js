      ...
      <div className="bg-white rounded-2xl w-full max-w-xl shadow-2xl overflow-hidden">
        ...
        <div className="px-7 py-6 flex flex-col gap-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* End time — sets the expected end of treatment to free up the schedule */}
            <div className="flex flex-col gap-1.5">
              ...
              <select className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 appearance-none focus:outline-none focus:ring-2 focus:ring-green-300">
                ...
                <option>2:30 PM</option><option>3:00 PM</option><option>3:30 PM</option><option>4:00 PM</option>
                <option>4:30 PM</option><option>5:00 PM</option>
              </select>
            </div>
          </div>
